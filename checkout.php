...
<div class="container">
    ...
    <div class="footBtn">
        <a href="services.php" class="btn btn-warning"><i class="glyphicon glyphicon-menu-left"></i> Add more services..</a>
        <a href="cartAction.php?action=placeOrder" class="btn btn-success orderBtn" target="_blank" onclick="document.location.href='home.php'">Generate Quote<i class="glyphicon glyphicon-menu-right"></i></a>
    </div>
</div>
</body>
</html>