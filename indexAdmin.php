...
<body>
<a href="home.php" ><img src="img/logo.png" style="float: left;margin-left: 10px;">
<h2 style="float: right;font-family:'Mukta Malar';margin-right: 10px;color: black!important; "><?php echo ucfirst($username);?></h2>
...
<nav id="nav-1">
    ...
    <a class="link-1" href="viewclients.php">Edit Clients</a>
    <a class="link-1" href="showOrders.php">Quote Info</a>
